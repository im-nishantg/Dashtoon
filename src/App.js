...
const App = () => {
  ...
  const Loader = () => {
    setError("");
    return(<div className="mb-5 w-50 d-flex flex-column align-content-center">
    <div className='d-flex w-100 justify-content-center'><img className='' src='https://i.gifer.com/ZZ5H.gif' height="45px" /></div>
  ...
  const printComic = ()=>{
    ...
    if(!allowDownload)
    {
      setDownloadError("Please generate at least one image to download.");
      return;
    }
  ...
  html2pdf(divElement.current, pdfOptions);
    
  }

  return (
    <div className='container d-flex flex-wrap w-100'>
        <div className='image-container d-flex flex-wrap justify-content-center' ref={divElement}>
      ...
      <div className='text-input-container w-100 d-flex flex-column align-items-center '>
        ...
        <div className='text-field mb-2 w-100 d-flex'>
          ...
          <button className='btn btn-primary ms-1' name='img1' onClick={handleSubmit}> + </button>
        </div>
        <div className='text-field mb-2 w-100 d-flex'>
          ...
          <button className='btn btn-primary ms-1' name='img2' onClick={handleSubmit}>  +</button>
        </div>
        <div className='text-field mb-2 w-100 d-flex'>
          ...
          <button className='btn btn-primary ms-1' name='img3' onClick={handleSubmit}>  +</button>
        </div>
        <div className='text-field mb-2 w-100 d-flex'>
          ...
          <button className='btn btn-primary ms-1' name='img4' onClick={handleSubmit}>  +</button>
        </div>
        <div className='text-field mb-2 w-100 d-flex'>
          ...
          <button className='btn btn-primary ms-1' name='img5' onClick={handleSubmit}>  +</button>
        </div>
        <div className='text-field mb-2 w-100 d-flex'>
          ...
          <button className='btn btn-primary ms-1' name='img6' onClick={handleSubmit}>  +</button>
        </div>
        <div className='text-field mb-2 w-100 d-flex'>
          ...
          <button className='btn btn-primary ms-1' name='img7' onClick={handleSubmit}>  +</button>
        </div>
        <div className='text-field mb-2 w-100 d-flex'>
          ...
          <button className='btn btn-primary ms-1' name='img8' onClick={handleSubmit}>  +</button>
        </div>
        <div className='text-field mb-2 w-100 d-flex'>
          ...
          <button className='btn btn-primary ms-1' name='img9' onClick={handleSubmit}>  +</button>
        </div>
        <div className='text-field mb-2 w-100 d-flex'>
          ...
          <button className='btn btn-primary ms-1' name='img10' onClick={handleSubmit}>  +</button>
        </div>
        <button className='btn btn-primary py-2 px-3 mt-3' onClick={printComic}> Download</button>
        {downloadError && <p className='mt-3'>{downloadError}</p>}
